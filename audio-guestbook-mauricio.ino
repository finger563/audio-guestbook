...
AudioPlaySdWav          playWav1; // Play 44.1kHz 16-bit PCM greeting WAV file - save greeting in WAV format on SD card (greeting.wav)
// Outputs
...
void setup() {
  ...
  sgtl5000_1.volume(0.5); // if you're getting distortion from the speaker, bring this down.
  ...
  // Value in dB, set through trial and error. if playback sound is too loud you can reduce, if too little, you can increase
